...
###
### API Call is GET /search/files - execute an ad-hoc search to list files
###
...
###
### Execute ad-hoc search within 10 miles of this location
###

url = 'https://api.eyefi.com/3/search/files'
data = { 'has_geodata': True, 'geo_lat': lat_param, 'geo_lon': lon_param, 'geo_distance': '5mi'}

### TODO add album id search id here

response = requests.get(url, json=data, headers=ef_authheaders())
